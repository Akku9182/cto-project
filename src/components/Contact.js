  ...
  const contactInfo = [
    {
      ...
      title: 'Email',
      value: 'vishrutshastri9182@gmail.com',
      link: 'mailto:vishrutshastri9182@gmail.com'
    },
    {
      icon: (
      ...
      title: 'LinkedIn',
      value: 'vishrutshastri',
      link: 'https://www.linkedin.com/in/vishrutshastri/'
    },
    {
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor">
      ...
      title: 'GitHub',
      value: 'Vish-rut',
      link: 'https://github.com/Vish-rut'
    },
    {
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
